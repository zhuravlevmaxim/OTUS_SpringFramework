...
import ru.otus.lesson31hw.repository.BookRepository;
import ru.otus.lesson31hw.repository.CommentRepository;
...
public class BookService {
    ...
    @HystrixCommand(commandKey = "getBooks", groupKey = "BookService")
    ...
    @HystrixCommand(commandKey = "addCommentInBook", groupKey = "BookService")
    ...
    @Secured({"ROLE_ADMIN"})
    @Transactional(readOnly = false)
    @HystrixCommand(commandKey = "editBook", groupKey = "BookService")
    ...
    @Secured({"ROLE_ADMIN"})
    @Transactional(readOnly = false)
    @HystrixCommand(commandKey = "editGenreInBook", groupKey = "BookService")
    ...
    @Secured({"ROLE_ADMIN"})
    @Transactional(readOnly = false)
    @HystrixCommand(commandKey = "addAuthorInBook", groupKey = "BookService")
    ...
    @Secured({"ROLE_ADMIN"})
    @Transactional(readOnly = false)
    @HystrixCommand(commandKey = "deleteAuthorFromBook", groupKey = "BookService")
    ...
    @Secured({"ROLE_ADMIN"})
    @Transactional(readOnly = false)
    @HystrixCommand(commandKey = "deleteCommentFromBook", groupKey = "BookService")
    ...
    @Secured({"ROLE_ADMIN"})
    @Transactional(readOnly = false)
    @HystrixCommand(commandKey = "createNewBook", groupKey = "BookService")
